...
exports.getDeclarations = exports.saveDeclaration = exports.calculateTax = void 0;
...
const saveDeclaration = async (req, res) => {
    try {
        ...
        const declaration = await prisma_1.default.taxDeclaration.create({
            data: {
                userId,
                taxType,
                period,
...
const getDeclarations = async (req, res) => {
    try {
        const userId = req.user.id;
        const declarations = await prisma_1.default.taxDeclaration.findMany({
            where: { userId },
